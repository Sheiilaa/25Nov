...
const Questions = () => {
  return (
    <article name="questions">
      <h2 className="title_article"> Por si lo necesitas</h2>
      <div className="container_article">
        <p>
          Lo primero de todo, decirte que no soy psicóloga, simplemente soy una
          chica que sabe por lo que has pasado y quiere ayudarte.
        </p>
        <p>
          ...
          escribir tu correo, twitter, instagram o cualquier red social y yo te
          escribiré para hablar contigo, pero si simplemente quieres contar algo
          de forma anónima también puedes, no es necesario que me digas quien
          eres.
        </p>
        <p>
          Por otro lado queria dejarte destacado el número de atención a las
          víctimas de violencia de genero, en el tendrás asesoramiento jurídico
